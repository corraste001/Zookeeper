...
while user_input != "exit":
    animal_number = animals[int(user_input)]
    if animal_number == animals[0]:
        print(camel)
    if animal_number == animals[1]:
        print(lion)
    if animal_number == animals[2]:
        print(deer)
    if animal_number == animals[3]:
        print(goose)
    if animal_number == animals[4]:
        print(bat)
    if animal_number == animals[5]:
        print(rabbit)
    user_input = input()
print("See you!")
